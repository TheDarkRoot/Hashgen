...
def Update():
    ...
    try:
        ...
        banner()
        time.sleep(0.5)
        print((BB+"["+WW+"="+BB+"] "+GG+"Installing modules: "+RR+"progressbar, passlib.\n"+W))
        
        os.system("pip2 install --upgrade pip")
        os.system("pip2 install passlib progressbar")
        
        print((BB+"\n["+WW+"="+BB+"] "+GG+"Installation successful. Run the program again.\n"+W))
        sys.exit()
