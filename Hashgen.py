...
if sys.platform == "linux" or sys.platform == "linux2":
    ...
    # Termux ve diğer platformlar için fallback
    BB = "\033[34;1m"
    YY = "\033[33;1m"
    GG = "\033[32;1m"
    WW = "\033[0;1m"
...
try:
    ...
    banner()
    time.sleep(0.5)
    print (BB+"["+WW+"="+BB+"] "+GG+"installing module "+RR+"progressbar2, passlib.\n"+W)
...
xb = x.encode('utf-8')  # hashlib için bytes versiyonu
...
# Ripemd160 - Python 3.9+ OpenSSL bağımlı, hata alınırsa atlanır
try:
    m = hashlib.new("ripemd160")
    m.update(xb)
    ripemd160 = m.hexdigest()
    print (YY+"["+WW+"12"+YY+"]>"+GG+"RIPEMD160 : "+W+ripemd160)
except ValueError:
    print (YY+"["+WW+"12"+YY+"]>"+GG+"RIPEMD160 : "+RR+"Not supported on this system"+W)

# Whirlpool - OpenSSL bağımlı, hata alınırsa atlanır
try:
    ...
    print (YY+"["+WW+"13"+YY+"]>"+GG+"WHIRLPOOL : "+RR+"Not supported on this system"+W)
...
crypt16_hash = crypt16.hash(x)
print (YY+"["+WW+"19"+YY+"]>"+GG+"Crypt16 : "+W+crypt16_hash)
